...
import be.faros.demos.stockgameserver.client.RestRouter;
...
public class ClientStarter {
    ...
    static class Client {
        ...
        void start() {
            ...
            /*
                TODO 2 For the next part, you have to register yourself in the system, so you can do some orders.
                When you register yourself, you will be given a token that you can reuse later on as a password to validate your orders.
                To do so, simply uncomment, and run the code below. Make sure to save the password you receive in the supplied Secrets class, so you can reuse it later!
             */
            /*
